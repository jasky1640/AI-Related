...
public abstract class Puzzle{
    ...
    //Get all the information for experiment part and discussion part
    public abstract void getExperimentAndDiscussionInfo();
    ...
    public void executeCommand(String command){
        ...
        else if (command.matches("getExperimentAndDiscussionInfo")){
        ...
        if(!state.isSolvable()){
            ...
            for(int index = 0; index < numberOfState && reachGoalState == false; index++){
                ...
                //The later ones will be generated by randomly moving 5 steps from the current state
                    ...
                    generatedState = State.randomizeBeamState(state, getMoveList(), 10, movesToCurrentNode);
                }
